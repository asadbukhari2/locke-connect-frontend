      ...
      <StyledProperty id="peopleFilter">
        <FilterHeader>
          <div className="wrap">
            <div className="heading-box">
              <h2>Peoples</h2>
              <span className="text">
                Total {peoples_data.totalItems} peoples
              </span>
            </div>
          ...
          <FilterWrap open={filterDropDown}>
            <SearchLocation handelFilter={handelProperFilter} />
        ...
        <StyledPropertyCards>
          {peoples_loading ? (
            ...
            peoples_data?.peoples?.map((elem) => (
              <PeopleCardWrapper
                $img={elem.photoURL ? elem.photoURL : img6.src}
                key={elem.id}
              >
                <button
                  className="btn"
                ...
                <CardTextPeople>
                  <span className="name">
                    {elem.displayName !== "" ? elem.displayName : "John Doe"}
                  </span>
                  <span className="info">
                  ...
                  <div className="socialIocn">
                    <div className="iconWrapp">
                      <span className="icon" onClick={() => handelFav(elem.id)}>
                        {elem.isFav ? (
                          <FaHeart size="16" />
                        ) : (
                          <FaRegHeart size="16" />
        ...
        {!!peoples_data?.peoples?.length && (
          <Pagination
            ...
            totalPages={
              peoples_data.totalItems
                ? Math.ceil(peoples_data.totalItems / searchQuery.pageSize)
                : 2
            }
            onPageChange={(val) => {
