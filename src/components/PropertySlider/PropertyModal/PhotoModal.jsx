...
const PhotoModal = () => {
  ...
  function handelFancy(e) {
    setInitialSlide(e);
    setModal(true);
  }
  return (
    <>
      <Modal width="900px" open={modal} setOpen={setModal} alignMiddle>
        <FancyBox data={PropertyDetail} start={initialSlide} />
      </Modal>
      <StyledPropertyModal>
        <div className="title">
          <span>Photo</span>
        ...
        <Imagesgallery>
          {PropertyDetail.map((elem, ind) => (
            <div key={ind} className="imgWrapper" onClick={() => handelFancy(ind)}>
